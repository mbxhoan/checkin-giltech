...
@section('content')
{{-- @dd(asset('assets/images/backgrounds/checkin-login.png'), public_path(('assets/images/backgrounds/checkin-login.png'))) --}}
        ...
        <div class="col-md-9 rounded shadow-sm bg-light" id="login-form-row" style="margin-top: 7%;">
            <div class="row rounded shadow-sm" style="
                ...
                <div class="col-md-6 p-5 rounded-start bg-white">
                    ...
                    <div class="mt-4">
                        <h4>Chúc mừng bạn đã xác minh tài khoản thành công!</h4>
                    </div>
