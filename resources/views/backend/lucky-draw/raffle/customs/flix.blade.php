...
<style>
    ...
    * {
    ...
    <body>
            ...
            <div class="row align-items-center position-relative" style="height: 100vh; background: url('{{ isset($luckyDrawReward->img_link) ? $luckyDrawReward->img_link : 'https://checkin.giltech.com.vn/storage/medias/629/BG-trống.png' }}') no-repeat center center; background-size: cover;">
