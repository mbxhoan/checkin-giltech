...
<style>
    ...
    * {
    ...
    <body>
            ...
            <div class="row align-items-center"  style="height: 100vh; background: url('{{ isset($luckyDrawReward->img_link) ? $luckyDrawReward->img_link : 'https://ck.delfi.vn/file/access/151' }}') no-repeat center center; background-size: cover;">
                ...
                <div class="col-lg-8 mx-auto text-center mb-3">
                    ...
                    <div class="box-container" id="boxContainer" style="margin-top: -22vh; padding-left: 40px; padding-right: 40px;"></div>
    ...
    <script src="{{ asset('js/lucky-draw/customs/longkan.js') }}"></script>
</html>
