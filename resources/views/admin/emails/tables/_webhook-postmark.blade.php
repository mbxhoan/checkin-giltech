                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            @if ($webhook->status === 'Delivery')
                                {{ \Carbon\Carbon::parse($webhook->convertToLocalTime())->addHours(7)->format('Y-m-d H:i:s') }}
                            @elseif (in_array($webhook->status, ['Click', 'Open']))
                                {{ \Carbon\Carbon::parse($webhook->convertToLocalTime())->subHours(7)->format('Y-m-d H:i:s') }}
                            @else
